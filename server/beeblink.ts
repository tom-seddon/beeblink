...
// **SPECIAL SYNTAX**
//
// The 0x00 or 0x80 byte is discarded, and the server enters sync mode.
export const REQUEST_TUBE_SERIAL_SYNC = 0x00;
export const REQUEST_TUBE_SERIAL_SYNC_ALT = 0x7f;

// **SPECIAL SYNTAX**
//
// The 0x01 byte is discarded, and the server starts to wait for another
// request. 
//
// 0x81 is not valid.
export const REQUEST_TUBE_SERIAL_PLACEHOLDER = 0x01;
