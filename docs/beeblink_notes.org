...
** TODO some other things I noticed...

*** TODO =getPersistentSettingsString= is never called

=*HSTATUS= should print it out?

*** TODO Previous directory is not shown anywhere

Again, should be something that =*HSTATUS= prints. More hooks
needed...

*** TODO =IFSType.findBeebFilesInVolume= might be pointless
...
** TODO Current directory can include wildcards
...
Affects at least these commands:
...
** TODO ADFS commands that will need implementing
