...
** TODO follow through due to getIdealAbsoluteServerPath
...
** TODO current dir is also known as =@=

** TODO separate FS number when in a hierarchical volume?
...
** TODO Drive letter alone doesn't parse
